...
watchEffect(() => {
    if (props.show) {
        ...
        form.errors = {};
        form.payment_channel = props.sale?.payment_channel;
        form.payment_type = props.sale?.payment_type;
        form.proof_of_payment = props.sale?.proof_of_payment;
        form.amount = props.sale?.amount;
        form.price = props.sale?.price;
        form.description = props.sale?.description;
