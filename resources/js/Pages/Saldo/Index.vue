...
import Create from "@/Pages/Saldo/Create.vue";
import Edit from "@/Pages/Saldo/Edit.vue";
import Delete from "@/Pages/Saldo/Delete.vue";
...
const selectAll = (event) => {
    if (event.target.checked === false) {
        ...
        props.saldos?.data.forEach((saldo) => {
            data.selectedId.push(saldo.id);
        });
    }
};
const select = () => {
    if (props.saldos?.data.length == data.selectedId.length) {
            ...
            >
                ...
                <div class="overflow-x-auto scrollbar-table">
                    <table class="w-full">
                        ...
                        <tbody>
                            <tr
                                v-for="(saldo, index) in saldos.data"
                                :key="index"
                            ...
                            >
                                ...
                                <td class="whitespace-nowrap py-4 px-2 sm:py-3">
                                    <p :class="saldo.type == 'masuk' ? 'text-green-600' : 'text-red-600'">
                                        {{ saldo.type == 'masuk' ? 'Uang Masuk' : 'Uang Keluar' }}
                                    </p>
                                </td>
                                <td class="whitespace-nowrap py-4 px-2 sm:py-3">
                                    <p style="white-space: normal; word-break: break-all; display: block;"> {{ saldo.description ?? '-' }}</p>
                                </td>
                                <td class="whitespace-nowrap py-4 px-2 sm:py-3">
                                    {{ saldo.date }}
                                </td>
                ...
                >
                    <Pagination :links="props.saldos" :filters="data.params" />
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
